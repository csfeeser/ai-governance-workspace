...
Overall human agreement rate: 82%. Override rate trend across the period: rising, from
roughly 11% in the first week to roughly 26% in the last.

## Reviewer quality audit

Two reviewers fall outside the normal range. R-A overrides 2% of AI decisions against a
