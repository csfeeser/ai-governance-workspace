...
![The Incident tab, showing Step 1 above the triaged incident](images/lab-4.2/1-the-incident.png)
...
![The What Happened tab, showing Step 2 above the supporting facts](images/lab-4.2/2-what-happened.png)
...
![The Impact and Ask tab, showing Step 6 above the supporting facts](images/lab-4.2/3-impact-and-ask.png)
...
![The Escalation Ticket tab, showing the ticket built from the student's answers](images/lab-4.2/4-escalation-ticket.png)
